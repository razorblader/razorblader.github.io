...
$query = $connection->query("SELECT * FROM products WHERE category = 'america' ");
...
?>
    <div class="item col-lg-4">
            <div class="thumbnail">
                <img src="img/<?php echo $row["image_url"]; ?>" alt="<?php echo $row["name"]; ?>" width="100%" height="auto" class="img-responsive">
                <div class="caption">
