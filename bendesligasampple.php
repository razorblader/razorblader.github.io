...
<div class="container" style="margin-top: 70px;">
    ...
    <header 
            ...
            <h1>Bundesliga Jerseys</h1>
    </header>

<div id="products" class="row list-group">
<?php
//Obtiene los registros de la tabla
$query = $connection->query("SELECT * FROM products WHERE category = 'bundes' ");
...
?>
    <div class="item col-lg-4">
            <div class="thumbnail">
                <img src="imgbundesligasample/<?php echo $row["image_url"]; ?>" alt="<?php echo $row["name"]; ?>" width="100%" height="auto" class="img-responsive">
                <div class="caption">
