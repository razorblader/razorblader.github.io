...
<head>
    ...
    <title>Serie A Jerseys Jerseys</title>
...
<div class="container" style="margin-top: 70px;">
    ...
    <header 
            ...
            <h1>Serie A Jerseys Jerseys</h1>
    </header>

<div id="products" class="row list-group">
<?php
//Obtiene los registros de la tabla
$query = $connection->query("SELECT * FROM products WHERE category = 'serie' ");
...
?>
    <div class="item col-lg-4">
            <div class="thumbnail">
                <img src="imgserieasampmle/<?php echo $row["image_url"]; ?>" alt="<?php echo $row["name"]; ?>" width="100%" height="auto" class="img-responsive">
                <div class="caption">
